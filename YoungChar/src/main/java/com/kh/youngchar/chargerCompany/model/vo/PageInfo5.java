...
public class PageInfo5 {
	...
	public PageInfo5(int currentPage, int listCount, int boardType) {
	...
	public PageInfo5(int currentPage, int listCount) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
	...
	public PageInfo5(int currentPage, int listCount, int limit, int pagingBarSize, int boardType) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
