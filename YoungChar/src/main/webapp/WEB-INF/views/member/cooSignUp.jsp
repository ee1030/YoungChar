...
<body>
      ...
      <img class="img-fluid" src="${contextPath}/resources/assets/images/테두리로고.png" alt="Logo">
        ...
        <fieldset>
          ...
          <button type="button" id="sendBtn" class="sendBtn">인증번호 전송</button>
        ...
        <fieldset>
        	...
        	<label for="memberNm">사원 명:</label>
          <input type="text" id="memberNm" name="memberNm" required>
       		

        	<label for="cooName">대리점 명:</label>
          <input type="text" id="cooName" name="cooName" required>
          
        
        <label for="brandCategory">브랜드 카테고리:</label>
        <select id="brandCategory" name="brandCategory">
          ...
          <input type="text" id="cooNumber" name="cooNumber" placeholder="' - ' 제외하고 입력" required>
       		
       		<label for="cooLicense">사업자 등록증:</label>
       		<div class="filebox">
       		<label for="img1">업로드</label>
          <input type="file" id="img1" name="images" required>
