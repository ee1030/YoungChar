				...
				<div class="row">
					<div class="col-lg-8 order-lg-1 pb-15">
						...
						<div class="rn-service-item">
							...
							<div class="rn-service-desc"><p>당일 예약</p></div>
						...
						<div class="rn-service-item">
							...
							<div class="rn-service-desc"><p>승인 대기</p></div>
							<div class="rn-service-title">5 건</div>
						</div>
						<!-- End Service Item-->
						...
						<div class="rn-service-item">
							...
							<div class="rn-service-desc"><p>시승 후기</p></div>
							<div class="rn-service-title">5 건</div>
						</div>
						<!-- End Service Item-->
