						...
						<div class="card">
							<div class="card-header">
								...
								<div class="search-page">
									<form action="${contextPath}/admin/replyManagement/searchId" method="post" class="theme-form">
											...
											<c:otherwise>
												<c:forEach var="reply" items="${rList}">
													...
													<tr>
														...
														<c:choose>
															<c:when test="${reply.replyStatus == 'N'}">
																<td style="color:red;">	
																	삭제됨
																</td>
															</c:when>
	...
	<script>
		...
		$("#delete").on("click", function(){
			...
			if(confirm("선택한 댓글을 삭제 하시겠습니까?")) {
				$.ajax({
					url : "${contextPath}/admin/replyManagement/delete",
					type : "POST",
					dataType : "json",
		...
		$("#restore").on("click", function(){
			...
			if(confirm("선택한 댓글을 복구하시겠습니까?")) {
				$.ajax({
					url : "${contextPath}/admin/replyManagement/restore",
					type : "POST",
					dataType : "json",
					data : { "chkList" : chkList },	
					success : function(result) {
